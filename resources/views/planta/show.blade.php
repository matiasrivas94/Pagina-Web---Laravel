            ...
            <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td> <a href="{{route('Planta.destroy',$pl) }}"><img width="20" height="20" src="https://icon-icons.com/icons2/10/PNG/128/cancel_stop_exit_1583.png" alt="Borrar"></a></td>
                        </tr>
                        @endforeach
                    </table>
            </div>
